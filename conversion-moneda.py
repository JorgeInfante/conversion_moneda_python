# Paso 1: Definr el valor actual del Euro y Dolar con respecto al Peso Mexicano

from unittest import result


tipo_cambio_eur_a_mxn = 23.70 #En un caso mas realizas habria que consumir informacion actrualizada de una BDD o API
tipo_cambio_usd_a_mxn = 20.75 #En un caso mas realizas habria que consumir informacion actrualizada de una BDD o API
...
# Pase 3: Solicitar al usuario el monto a convertir
